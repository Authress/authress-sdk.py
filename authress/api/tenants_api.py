...
class TenantsApi(object):
    ...
    @validate_arguments
    def delete_tenant(self, tenant_id : Annotated[constr(strict=True, max_length=64, min_length=0), Field(..., description="The tenantId.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_tenant_with_http_info(self, tenant_id : Annotated[constr(strict=True, max_length=64, min_length=0), Field(..., description="The tenantId.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete tenant  # noqa: E501
    ...
    @validate_arguments
    def get_tenant(self, tenant_id : Annotated[constr(strict=True, max_length=64, min_length=0), Field(..., description="The tenantId.")], **kwargs) -> Tenant:  # noqa: E501
    ...
    @validate_arguments
    def get_tenant_with_http_info(self, tenant_id : Annotated[constr(strict=True, max_length=64, min_length=0), Field(..., description="The tenantId.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Retrieve tenant  # noqa: E501
    ...
    @validate_arguments
    def update_tenant(self, tenant_id : Annotated[constr(strict=True, max_length=64, min_length=0), Field(..., description="The tenantId.")], tenant : Tenant, **kwargs) -> Tenant:  # noqa: E501
    ...
    @validate_arguments
    def update_tenant_with_http_info(self, tenant_id : Annotated[constr(strict=True, max_length=64, min_length=0), Field(..., description="The tenantId.")], tenant : Tenant, **kwargs) -> ApiResponse:  # noqa: E501
        """Update tenant  # noqa: E501
