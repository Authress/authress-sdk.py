...
class HttpClient(object):
    ...
    :param host: The authress custom Domain
    :param access_key: The service client access key
    """
    ...
    @classmethod
    def get_default(cls):
        """Return new instance of HttpClient.

        This method returns newly created, based on default constructor,
        object of HttpClient class or returns a copy of default
        HttpClient.

        :return: The HttpClient object.
        """
        if cls._default is None:
            cls._default = HttpClient()
        return cls._default

    @classmethod
    def set_default(cls, default):
        """Set default instance of HttpClient.

        It stores default HttpClient.

        :param default: object of HttpClient.
        """
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(authress.models, klass)
