...
class AccessRecordCollection(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> AccessRecordCollection:
        ...
        if not isinstance(obj, dict):
            if isinstance(obj, AccessRecordCollection):
                return obj
            return lenient_construct(AccessRecordCollection, {})

        _obj = lenient_construct(AccessRecordCollection, {
            "records": lenient_nested_list(AccessRecord, obj.get("records")),
