...
class AccessRequestCollection(BaseModel):
    """
    A collection of access requests  # noqa: E501
    """
    records: Optional[conlist(AccessRequest)] = Field(default=None, description="A list of access requests")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccessRequestCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccessRequestCollection:
        """Create an instance of AccessRequestCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            if isinstance(obj, AccessRequestCollection):
                return obj
            return lenient_construct(AccessRequestCollection, {})

        _obj = lenient_construct(AccessRequestCollection, {
            "records": lenient_nested_list(AccessRequest, obj.get("records")),
