...
class ApplicationDelegation(BaseModel):
    """
    The delegation response.  # noqa: E501
    """
    authentication_url: StrictStr = Field(default=..., alias="authenticationUrl", description="Redirect the user to this url to automatically log them into a third-party application.")
    __properties = ["authenticationUrl"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationDelegation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationDelegation:
