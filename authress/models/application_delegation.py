...
class ApplicationDelegation(BaseModel):
    ...
    """
    authentication_url: StrictStr = Field(..., alias="authenticationUrl", description="Redirect the user to this url to automatically log them into a third-party application.")
