...
class ExtensionApplication(BaseModel):
    ...
    """
    application_id: StrictStr = Field(..., alias="applicationId", description="The unique ID of the application.")
    redirect_urls: Optional[conlist(constr(strict=True, max_length=1024))] = Field(None, alias="redirectUrls")
    links: Links = Field(...)
