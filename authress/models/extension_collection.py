...
class ExtensionCollection(BaseModel):
    """
    A collection of platform extensions.  # noqa: E501
    """
    extensions: conlist(Extension) = Field(...)
    pagination: Optional[Pagination] = None
    __properties = ["extensions", "pagination"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtensionCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtensionCollection:
