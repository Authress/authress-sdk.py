...
class Identity(BaseModel):
    ...
    """
    issuer: StrictStr = Field(..., description="The issuer of the JWT token. This can be any OIDC compliant provider.")
    audience: StrictStr = Field(..., description="The audience of the JWT token. This can be either an audience for your entire app, or one particular audience for it. If there is more than one audience, multiple identities can be created.")
    __properties = ["issuer", "audience"]
