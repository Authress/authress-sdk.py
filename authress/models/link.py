...
class Link(BaseModel):
    ...
    """
    href: StrictStr = Field(..., description="The absolute url pointing to the reference resource.")
    rel: Optional[StrictStr] = Field(None, description="Optional property indicating the type of link if it is not a default IANA approved global link relation.")
