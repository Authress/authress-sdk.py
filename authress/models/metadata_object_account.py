...
class MetadataObjectAccount(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MetadataObjectAccount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MetadataObjectAccount:
        """Create an instance of MetadataObjectAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MetadataObjectAccount.parse_obj(obj)

        _obj = MetadataObjectAccount.parse_obj({
