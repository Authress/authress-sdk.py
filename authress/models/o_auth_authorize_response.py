...
class OAuthAuthorizeResponse(BaseModel):
    ...
    """
    code: StrictStr = Field(default=..., description="The authorization code to be used with the /tokens endpoint to retrieve an access_token.")
    __properties = ["code"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OAuthAuthorizeResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OAuthAuthorizeResponse:
