...
class OAuthTokenResponse(BaseModel):
    ...
    OAuthTokenResponse
    """
    access_token: StrictStr = Field(default=..., description="An expiring access token that can be used to access either Authress or any platform service.")
    ...
    def from_dict(cls, obj: dict) -> OAuthTokenResponse:
        ...
        if not isinstance(obj, dict):
            if isinstance(obj, OAuthTokenResponse):
                return obj
            return lenient_construct(OAuthTokenResponse, {})

        _obj = lenient_construct(OAuthTokenResponse, {
