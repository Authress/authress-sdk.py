...
class PermissionCollectionAccount(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PermissionCollectionAccount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PermissionCollectionAccount:
        """Create an instance of PermissionCollectionAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            if isinstance(obj, PermissionCollectionAccount):
                return obj
            return lenient_construct(PermissionCollectionAccount, {})

        _obj = lenient_construct(PermissionCollectionAccount, {
