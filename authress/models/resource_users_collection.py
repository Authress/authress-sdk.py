...
class ResourceUsersCollection(BaseModel):
    """
    A collection of users with explicit permission to a resource.  # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> ResourceUsersCollection:
        ...
        if not isinstance(obj, dict):
            if isinstance(obj, ResourceUsersCollection):
                return obj
            return lenient_construct(ResourceUsersCollection, {})

        _obj = lenient_construct(ResourceUsersCollection, {
            "users": lenient_nested_list(UserRoleCollection, obj.get("users")),
