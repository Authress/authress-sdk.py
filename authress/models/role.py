...
class Role(BaseModel):
    """
    The role which contains a list of permissions.  # noqa: E501
    """
    role_id: Optional[constr(strict=True, max_length=64, min_length=1)] = Field(default=None, alias="roleId", description="Unique identifier for the role, can be specified on creation, and used by records to map to permissions.")
    name: constr(strict=True, max_length=128, min_length=1) = Field(default=..., description="A helpful name for this role")
    description: Optional[constr(strict=True, max_length=1024, min_length=0)] = Field(default=None, description="A description for when to the user as well as additional information.")
    permissions: conlist(PermissionObject, max_items=100, min_items=0) = Field(default=..., description="A list of the permissions")
    ...
    def from_dict(cls, obj: dict) -> Role:
        ...
        if not isinstance(obj, dict):
            if isinstance(obj, Role):
                return obj
            return lenient_construct(Role, {})

        _obj = lenient_construct(Role, {
