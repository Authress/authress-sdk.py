...
class RoleCollection(BaseModel):
    """
    A collection of roles  # noqa: E501
    """
    roles: conlist(Role) = Field(default=..., description="A list of roles")
    pagination: Optional[Pagination] = None
    links: CollectionLinks = Field(...)
    __properties = ["roles", "pagination", "links"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RoleCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RoleCollection:
        """Create an instance of RoleCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            if isinstance(obj, RoleCollection):
                return obj
            return lenient_construct(RoleCollection, {})

        _obj = lenient_construct(RoleCollection, {
            "roles": lenient_nested_list(Role, obj.get("roles")),
