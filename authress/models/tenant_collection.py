...
class TenantCollection(BaseModel):
    """
    A collection of tenants.  # noqa: E501
    """
    tenants: conlist(Tenant) = Field(...)
    pagination: Optional[Pagination] = None
    __properties = ["tenants", "pagination"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TenantCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TenantCollection:
        """Create an instance of TenantCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            if isinstance(obj, TenantCollection):
                return obj
            return lenient_construct(TenantCollection, {})

        _obj = lenient_construct(TenantCollection, {
            "tenants": lenient_nested_list(Tenant, obj.get("tenants")),
