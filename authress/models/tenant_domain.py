...
class TenantDomain(BaseModel):
    """
    The tenant linked domain configuration.  # noqa: E501
    """
    domain: constr(strict=True, max_length=128, min_length=1) = Field(default=..., description="The tenant linked domain.")
    __properties = ["domain"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TenantDomain:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TenantDomain:
