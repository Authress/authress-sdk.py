...
class TenantUser(BaseModel):
    ...
    TenantUser
    """
    user_id: Optional[constr(strict=True, max_length=128, min_length=1)] = Field(default=None, alias="userId")
    __properties = ["userId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TenantUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TenantUser:
        ...
        if not isinstance(obj, dict):
            if isinstance(obj, TenantUser):
                return obj
            return lenient_construct(TenantUser, {})

        _obj = lenient_construct(TenantUser, {
