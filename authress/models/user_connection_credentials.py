...
class UserConnectionCredentials(BaseModel):
    """
    The user credentials for this connection which can be used to access the connection provider APIs.  # noqa: E501
    """
    access_token: StrictStr = Field(default=..., alias="accessToken", description="The access token.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserConnectionCredentials:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserConnectionCredentials:
