...
class UserIdentity(BaseModel):
    """
    The composite user identity stored in Authress sourced by the customer SSO/SAML/OAuth IdP.  # noqa: E501
    """
    user_id: constr(strict=True, max_length=128, min_length=1) = Field(default=..., alias="userId")
    name: Optional[StrictStr] = Field(default=None, description="The user's formatted display name.")
    picture: Optional[StrictStr] = Field(default=None, description="A url that resolves to a picture that can be rendered.")
    email: Optional[StrictStr] = Field(default=None, description="The user's verified email address sourced from their SSO IdP.")
