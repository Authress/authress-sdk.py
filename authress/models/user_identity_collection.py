...
class UserIdentityCollection(BaseModel):
    ...
    """
    users: conlist(UserIdentity) = Field(..., description="A list of users")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserIdentityCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserIdentityCollection:
        """Create an instance of UserIdentityCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserIdentityCollection.parse_obj(obj)

        _obj = UserIdentityCollection.parse_obj({
            "users": [UserIdentity.from_dict(_item) for _item in obj.get("users")] if obj.get("users") is not None else None,
