...
class UserRole(BaseModel):
    """
    A role with associated role data.  # noqa: E501
    """
    role_id: constr(strict=True, max_length=64, min_length=1) = Field(default=..., alias="roleId", description="Unique identifier for the role, can be specified on creation, and used by records to map to permissions.")
    __properties = ["roleId"]
    ...
    def from_dict(cls, obj: dict) -> UserRole:
        ...
        if not isinstance(obj, dict):
            if isinstance(obj, UserRole):
                return obj
            return lenient_construct(UserRole, {})

        _obj = lenient_construct(UserRole, {
