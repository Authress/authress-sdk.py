...
from authress.models.access_record import AccessRecord  # noqa: E501

class TestAccessRecord(unittest.TestCase):
    """AccessRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessRecord:
        """Test AccessRecord
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessRecord`
        """
        model = AccessRecord()  # noqa: E501
        if include_optional:
            return AccessRecord(
                record_id = 'C0',
                name = '0',
