...
from authress.models.access_record_account import AccessRecordAccount  # noqa: E501

class TestAccessRecordAccount(unittest.TestCase):
    """AccessRecordAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessRecordAccount:
        """Test AccessRecordAccount
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessRecordAccount`
        """
        model = AccessRecordAccount()  # noqa: E501
        if include_optional:
            return AccessRecordAccount(
                account_id = ''
            )
        else:
            return AccessRecordAccount(
    ...
    def testAccessRecordAccount(self):
        """Test AccessRecordAccount"""
