...
import authress
from authress.models.account_collection import AccountCollection  # noqa: E501
...
class TestAccountCollection(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = authress.models.account_collection.AccountCollection()  # noqa: E501
        if include_optional :
            return AccountCollection(
                accounts = authress.models.account.Account(
                    account_id = '0', 
                    created_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    name = '', 
                    company = authress.models.company.company(), 
