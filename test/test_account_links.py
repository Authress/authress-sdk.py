...
from authress.models.account_links import AccountLinks  # noqa: E501
...
class TestAccountLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccountLinks:
        """Test AccountLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountLinks`
        """
        model = AccountLinks()  # noqa: E501
        if include_optional:
            return AccountLinks(
                var_self = authress.models.link.Link(
                    href = '', 
                    rel = '', )
            )
        else:
