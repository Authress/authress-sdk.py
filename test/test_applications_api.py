...
import authress
from authress.api.applications_api import ApplicationsApi  # noqa: E501
...
class TestApplicationsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = authress.api.applications_api.ApplicationsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_delegate_user_login(self):
        """Test case for delegate_user_login
