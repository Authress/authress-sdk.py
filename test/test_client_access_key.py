...
from authress.models.client_access_key import ClientAccessKey  # noqa: E501

class TestClientAccessKey(unittest.TestCase):
    """ClientAccessKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientAccessKey:
        """Test ClientAccessKey
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientAccessKey`
        """
        model = ClientAccessKey()  # noqa: E501
        if include_optional:
