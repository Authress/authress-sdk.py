...
from authress.models.client_options import ClientOptions  # noqa: E501
...
class TestClientOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClientOptions:
        """Test ClientOptions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientOptions`
        """
        model = ClientOptions()  # noqa: E501
        if include_optional:
