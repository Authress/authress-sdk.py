...
from authress.models.client_rate_limit import ClientRateLimit  # noqa: E501

class TestClientRateLimit(unittest.TestCase):
    """ClientRateLimit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientRateLimit:
        """Test ClientRateLimit
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientRateLimit`
        """
        model = ClientRateLimit()  # noqa: E501
        if include_optional:
