...
from authress.models.connection_conditions import ConnectionConditions  # noqa: E501

class TestConnectionConditions(unittest.TestCase):
    """ConnectionConditions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionConditions:
        """Test ConnectionConditions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionConditions`
        """
        model = ConnectionConditions()  # noqa: E501
        if include_optional:
    ...
    def testConnectionConditions(self):
        """Test ConnectionConditions"""
