...
from authress.models.connection_linking_configuration import ConnectionLinkingConfiguration  # noqa: E501

class TestConnectionLinkingConfiguration(unittest.TestCase):
    """ConnectionLinkingConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionLinkingConfiguration:
        """Test ConnectionLinkingConfiguration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionLinkingConfiguration`
        """
        model = ConnectionLinkingConfiguration()  # noqa: E501
        if include_optional:
            return ConnectionLinkingConfiguration(
                type = 'EXPLICIT'
            )
        else:
            return ConnectionLinkingConfiguration(
    ...
    def testConnectionLinkingConfiguration(self):
        """Test ConnectionLinkingConfiguration"""
