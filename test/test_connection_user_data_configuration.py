...
from authress.models.connection_user_data_configuration import ConnectionUserDataConfiguration  # noqa: E501

class TestConnectionUserDataConfiguration(unittest.TestCase):
    """ConnectionUserDataConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionUserDataConfiguration:
        """Test ConnectionUserDataConfiguration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionUserDataConfiguration`
        """
        model = ConnectionUserDataConfiguration()  # noqa: E501
        if include_optional:
            return ConnectionUserDataConfiguration(
                location = 'ZAF'
            )
        else:
            return ConnectionUserDataConfiguration(
    ...
    def testConnectionUserDataConfiguration(self):
        """Test ConnectionUserDataConfiguration"""
