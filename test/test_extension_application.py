...
from authress.models.extension_application import ExtensionApplication  # noqa: E501

class TestExtensionApplication(unittest.TestCase):
    """ExtensionApplication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtensionApplication:
        """Test ExtensionApplication
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtensionApplication`
        """
        model = ExtensionApplication()  # noqa: E501
        if include_optional:
    ...
    def testExtensionApplication(self):
        """Test ExtensionApplication"""
