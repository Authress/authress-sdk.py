...
from authress.models.identity_collection import IdentityCollection  # noqa: E501

class TestIdentityCollection(unittest.TestCase):
    """IdentityCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdentityCollection:
        """Test IdentityCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdentityCollection`
        """
        model = IdentityCollection()  # noqa: E501
        if include_optional:
            return IdentityCollection(
                identities = [
                    authress.models.identity.Identity(
                        issuer = '', 
                        audience = '', 
    ...
    def testIdentityCollection(self):
        """Test IdentityCollection"""
