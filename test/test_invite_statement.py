...
from authress.models.invite_statement import InviteStatement  # noqa: E501

class TestInviteStatement(unittest.TestCase):
    """InviteStatement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InviteStatement:
        """Test InviteStatement
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InviteStatement`
        """
        model = InviteStatement()  # noqa: E501
        if include_optional:
