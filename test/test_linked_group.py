...
from authress.models.linked_group import LinkedGroup  # noqa: E501

class TestLinkedGroup(unittest.TestCase):
    """LinkedGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkedGroup:
        """Test LinkedGroup
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkedGroup`
        """
        model = LinkedGroup()  # noqa: E501
        if include_optional:
            return LinkedGroup(
