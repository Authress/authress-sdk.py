...
import authress
from authress.models.metadata_object import MetadataObject  # noqa: E501
...
class TestMetadataObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `MetadataObject`
        """
        model = authress.models.metadata_object.MetadataObject()  # noqa: E501
        if include_optional :
            return MetadataObject(
                account = authress.models.metadata_object_account.MetadataObject_account(
                    account_id = '', ), 
                user_id = None, 
                metadata = {}
            )
