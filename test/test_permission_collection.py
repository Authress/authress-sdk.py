...
from authress.models.permission_collection import PermissionCollection  # noqa: E501

class TestPermissionCollection(unittest.TestCase):
    """PermissionCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PermissionCollection:
        """Test PermissionCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionCollection`
        """
        model = PermissionCollection()  # noqa: E501
        if include_optional:
    ...
    def testPermissionCollection(self):
        """Test PermissionCollection"""
