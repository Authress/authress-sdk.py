...
from authress.models.permission_collection_account import PermissionCollectionAccount  # noqa: E501

class TestPermissionCollectionAccount(unittest.TestCase):
    """PermissionCollectionAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PermissionCollectionAccount:
        """Test PermissionCollectionAccount
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionCollectionAccount`
        """
        model = PermissionCollectionAccount()  # noqa: E501
        if include_optional:
            return PermissionCollectionAccount(
                account_id = ''
            )
        else:
            return PermissionCollectionAccount(
    ...
    def testPermissionCollectionAccount(self):
        """Test PermissionCollectionAccount"""
