...
class TestResourcePermissionsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = authress.api.resource_permissions_api.ResourcePermissionsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_get_permissioned_resource(self):
    ...
    def test_get_permissioned_resources(self):
    ...
    def test_get_resource_users(self):
    ...
    def test_update_permissioned_resource(self):
