...
from authress.models.resource_users_collection import ResourceUsersCollection  # noqa: E501

class TestResourceUsersCollection(unittest.TestCase):
    """ResourceUsersCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourceUsersCollection:
        """Test ResourceUsersCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourceUsersCollection`
        """
        model = ResourceUsersCollection()  # noqa: E501
        if include_optional:
            return ResourceUsersCollection(
                users = [
                    authress.models.user_role_collection.UserRoleCollection(
                        user_id = None, 
                        roles = [
                            authress.models.user_role.UserRole(
                                role_id = None, )
                            ], )
                    ],
    ...
    def testResourceUsersCollection(self):
        """Test ResourceUsersCollection"""
