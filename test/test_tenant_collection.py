...
class TestTenantCollection(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TenantCollection:
        ...
        """
        model = TenantCollection()  # noqa: E501
        if include_optional:
            return TenantCollection(
                tenants = [
                    authress.models.tenant.Tenant(
                        tenant_id = '', 
                        tenant_lookup_identifier = '', 
                        data = authress.models.tenant_data.Tenant_data(
                            name = '', ), 
                        domains = [
                            authress.models.tenant_domain.TenantDomain(
                                domain = 'y0', )
                            ], 
