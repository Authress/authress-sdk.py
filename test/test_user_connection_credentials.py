...
from authress.models.user_connection_credentials import UserConnectionCredentials  # noqa: E501

class TestUserConnectionCredentials(unittest.TestCase):
    """UserConnectionCredentials unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserConnectionCredentials:
        """Test UserConnectionCredentials
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserConnectionCredentials`
        """
        model = UserConnectionCredentials()  # noqa: E501
        if include_optional:
    ...
    def testUserConnectionCredentials(self):
        """Test UserConnectionCredentials"""
