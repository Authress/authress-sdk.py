...
from authress.models.user_role_collection import UserRoleCollection  # noqa: E501

class TestUserRoleCollection(unittest.TestCase):
    """UserRoleCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserRoleCollection:
        """Test UserRoleCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserRoleCollection`
        """
        model = UserRoleCollection()  # noqa: E501
        if include_optional:
    ...
    def testUserRoleCollection(self):
        """Test UserRoleCollection"""
